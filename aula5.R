...
rating.Histrogram <- rating.Histrogram + theme_bw()
...
size.App.Plot <- size.App.Plot + ggtitle("Histograma Size App(tamanho de instalaçâo do app)")
...
nota_plot
nota_plot + geom_line(aes(as.Date(data_2), media), color = "blue") + theme_bw() + ggtitle("Média das Avalia????es dos Apps") + xlab("Data") + ylab("M??dia Nota")
